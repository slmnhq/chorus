chorus.views.WorkfileShowSidebar = chorus.views.Sidebar.extend({
    ...
    resourcesLoaded:function () {
        ...
        if (this.model.isSql()) {
            ...
            this.functionList = new chorus.views.DatabaseFunctionSidebarList({ sandbox:this.model.sandbox() });
            this.datasetList = new chorus.views.DatabaseDatasetSidebarList({ sandbox:this.model.sandbox() });
            this.columnList = new chorus.views.DatabaseColumnSidebarList({ sandbox:this.model.sandbox() });
