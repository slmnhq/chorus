chorus.collections.DatabaseColumnSet = chorus.collections.Base.extend({
    ...
    urlTemplate: function() {
        if (this.attributes.tableName) {
            return "data/{{instanceId}}/database/{{encodeOnce databaseName}}/schema/{{encodeOnce schemaName}}/table/{{encodeOnce tableName}}/column";
        } else if (this.attributes.viewName) {
            return "data/{{instanceId}}/database/{{encodeOnce databaseName}}/schema/{{encodeOnce schemaName}}/view/{{encodeOnce viewName}}/column";
