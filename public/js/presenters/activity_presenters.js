...
(function(ns) {
    ns.presenters.Activity = function(model){
        ...
        var presenter = new constructor().make(model)
        presenter.header = {
            type: model.get("type"),
    ...
    ns.presenters.Activity.Base = function() {
        this.make = function(model) {
        ...
        this.subComments = function(model){
    ...
    ns.presenters.Activity.NOTE = function() {
        this.make = function(model) {
            return extendBase(model, { objectUrl : 'foo' })
        }
    };

    ns.presenters.Activity.WORKSPACE_DELETED = function(){
        this.make = function(model){
    ...
    ns.presenters.Activity.WORKSPACE_CREATED = function(){
        this.make = function(model){
            var original = extendBase(model);
            return extendBase(model, {
                objectName : original.workspaceName,
    ...
    ns.presenters.Activity.WORKFILE_CREATED = function(){
        this.make = function(model) {
            return extendBase(model, {
    ...
    ns.presenters.Activity.USER_ADDED = function(){
        this.make = function(model) {
    ...
    function extendBase(model, overrides) {
        return _.extend(new ns.presenters.Activity.Base().make(model) , overrides)
    }
})(chorus);