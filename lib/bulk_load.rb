...
system "psql -p 8543 chorus_rails_test -c 'ALTER TABLE public.workspaces ADD COLUMN legacy_id INTEGER;'"
...
system "psql -p 8543 chorus_rails_test -c 'ALTER TABLE public.memberships ADD COLUMN legacy_id INTEGER;'"
