module SolrHelpers
  ...
  def create_solr_fixtures
    VCR.use_cassette('search_solr_index') do
      ...
      admin = FactoryGirl.create(:admin, :id => 1_000_000)
      some_user = FactoryGirl.create(:user, :id => 1_000_001, :username => 'some_user', :first_name => "marty", :last_name => "alpha")
      bob = FactoryGirl.create(:user, :id => 1_000_002, :username => 'some_other_user', :first_name => "bob", :last_name => "alpha")
