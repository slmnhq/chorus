module SolrHelpers
  ...
  def create_solr_fixtures
    VCR.use_cassette('search_solr_index') do
      ...
      FactoryGirl.create(:user, :id => 100, :username => 'some_user', :first_name => "marty", :last_name => "alpha")
      FactoryGirl.create(:user, :id => 101, :username => 'some_other_user', :first_name => "bob", :last_name => "alpha")
