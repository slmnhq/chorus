...
FixtureBuilder.configure do |fbuilder|
  ...
  fbuilder.factory do
    ...
    fbuilder.name(:notification1, Notification.create!({:recipient => owner, :notification_event => notes[0], :comment => second_comment_on_note_on_greenplum}, :without_protection => true) )
