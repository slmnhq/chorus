...
FixtureBuilder.configure do |fbuilder|
  ...
  fbuilder.factory do
    ...
    chorus_gpdb40_instance = Instance.create!({ :name => "chorus_gpdb40", :host => "chorus-gpdb40.sf.pivotallabs.com", :port => "5432", :maintenance_db => "postgres", :owner => admin}, :without_protection => true)
    ...
    chorus_gpdb40_instance_account = InstanceAccount.create!({:owner => admin, :instance => chorus_gpdb40_instance, :db_username => 'test_superuser', :db_password => 'secret'}, :without_protection => true)
    fbuilder.name(:chorus_gpdb40_test_superuser, chorus_gpdb40_instance_account)
    chorus_gpdb41_instance_account = InstanceAccount.create!({:owner => admin, :instance => chorus_gpdb41_instance, :db_username => 'test_superuser', :db_password => 'secret'}, :without_protection => true)
    fbuilder.name(:chorus_gpdb41_test_superuser, chorus_gpdb41_instance_account)
    chorus_gpdb42_instance_account = InstanceAccount.create!({:owner => admin, :instance => chorus_gpdb42_instance, :db_username => 'test_superuser', :db_password => 'secret'}, :without_protection => true)
