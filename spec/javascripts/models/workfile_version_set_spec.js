describe("chorus.models.WorkfileVersion", function() {
    beforeEach(function() {
        ...
        this.collection.add({versionInfo: {id: 10, versionNum: 1}});
        this.collection.add({versionInfo: {id: 11, versionNum: 2}});
        this.collection.add({versionInfo: {id: 12, versionNum: 3}});
    });
