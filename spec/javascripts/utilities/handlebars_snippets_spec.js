describe("handlebars", function() {
    describe("registered helpers", function() {
        ...
        describe("eachWithMoreLink", function() {
            ...
            describe("when the collection has more than max elements", function() {
                describe("when showLast is false", function() {
                    beforeEach(function() {
                        this.collection = [
                            { name: "foo" },
                            { name: "bar" },
                        ...
                        Handlebars.helpers.eachWithMoreLink(this.collection, 2, "activity_stream.comments.more",
                            "activity_stream.comments.less", false,  this.yieldSpy, this.yieldSpy.inverse);
                    });
        ...
        describe("tabularDataLocation", function() {
            ...
            context("when user provided a label", function () {
                beforeEach(function() {
                    this.model = fixtures.tabularData()
                    this.result = Handlebars.helpers.tabularDataLocation(this.model, 'workspace.sandbox_schema').toString();
                });
