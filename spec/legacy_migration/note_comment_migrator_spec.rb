...
#      expect { NoteCommentMigrator.new.migrate }.to change(Events::NoteOnGreenplumInstance.unscoped, :count).by(5)
...
#        note = Events::NoteOnGreenplumInstance.find_by_id(legacy_comment["chorus_rails_event_id"])
#        next unless note
...
#      expect { NoteCommentMigrator.new.migrate }.to change(Events::NoteOnHadoopInstance.unscoped, :count).by(2)
#      Legacy.connection.select_all("SELECT ec.*, chorus_rails_user_id FROM edc_comment ec,edc_user eu where entity_type = 'instance' and ec.author_name = eu.user_name").each do |legacy_comment|
#        note = Events::NoteOnHadoopInstance.find_by_id(legacy_comment["chorus_rails_event_id"])
#        next unless note
#        note.body.should == legacy_comment["body"]
#        note.created_at.should == legacy_comment["created_stamp"]
#        note.updated_at.should == legacy_comment["last_updated_stamp"]
...
#      expect { NoteCommentMigrator.new.migrate }.to change(Events::NoteOnHdfsFile.unscoped, :count).by(6)
...
#        note = Events::NoteOnHdfsFile.find(legacy_comment["chorus_rails_event_id"])
#        note.body.should == legacy_comment["body"]
#        note.created_at.should == legacy_comment["created_stamp"]
#        note.updated_at.should == legacy_comment["last_updated_stamp"]
#        note.actor_id.should == User.find_with_destroyed(legacy_comment["chorus_rails_user_id"]).id
...
#      expect { NoteCommentMigrator.new.migrate }.to change(Events::NoteOnWorkspace.unscoped, :count).by(40)
...
#        note = Events::NoteOnWorkspace.find_with_destroyed(legacy_comment["chorus_rails_event_id"])
#        note.body.should == legacy_comment["body"]
#        note.created_at.should == legacy_comment["created_stamp"]
#        note.updated_at.should == legacy_comment["last_updated_stamp"]
#        note.actor_id.should == User.find_with_destroyed(legacy_comment["chorus_rails_user_id"]).id
...
#      expect { NoteCommentMigrator.new.migrate }.to change(Events::NoteOnWorkfile.unscoped, :count).by(5)
...
#        note = Events::NoteOnWorkfile.find(legacy_comment["chorus_rails_event_id"])
#        note.body.should == legacy_comment["body"]
...
#      expect { NoteCommentMigrator.new.migrate }.to change(Events::NoteOnWorkspaceDataset.unscoped, :count).by(18)
...
#        note = Events::NoteOnWorkspaceDataset.find(legacy_comment["chorus_rails_event_id"])
#        note.body.should == legacy_comment["body"]
#        note.workspace.should == Workspace.find_with_destroyed(legacy_comment["chorus_rails_workspace_id"])
