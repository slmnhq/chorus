...
def create_gpdb_instance(params={})
  register_gpdb_instance(:name => params[:name] || "GPDB_Instance#{Time.now.to_i}",
                         ...
                         :host => params[:host] || WEBPATH['gpdb_instance']['gpdb_host'],
                         :port => params[:port] || WEBPATH['gpdb_instance']['gpdb_port'],
                         :dbuser => params[:dbuser] || WEBPATH['gpdb_instance']['gpdb_user'],
                         :dbpass => params[:dbpass] || WEBPATH['gpdb_instance']['gpdb_pass'],
...
def create_gpdb_instance_no_ui(params={})
  Gpdb::InstanceRegistrar.create!({
                                    ...
                                    :db_username => params[:dbuser] || WEBPATH['gpdb_instance']['gpdb_user'],
                                    :db_password => params[:dbpass] || WEBPATH['gpdb_instance']['gpdb_pass']
